...
# Configuração da IA (Novo Padrão)
client = genai.Client(api_key=os.getenv("IA_API_KEY"))
embedding_model = "gemini-embedding-001" # <-- MODELO MAIS RECENTE E PODEROSO
        ...
        for i, trecho in enumerate(pedacos):
            ...
            try:
                ...
                banco_de_conhecimento.append({
                    ...
                    "titulo": titulo_fatia,
                    "texto": trecho,
                    "vetor": result.embeddings[0].values # Pega a lista de números do vetor
                })
